...
class ESKF(object):
    ...
    def __init__(self, config) -> None:
        ...
        self.ref_pos_lla = np.array([config['ref_latitude'],config['ref_longitude'],config['ref_altitude']]).reshape(3,1)
    ...
    def Init(self, data_path:str):
        ...
        self.rotation_matrix_ = euler2rm(np.array([0, 0, 0]))
    ...
    def EliminateError(self):
        ...
        self.rotation_matrix_ = rv2rm(-self.X[INDEX_STATE_ORI:INDEX_STATE_GYRO_BIAS, :]) @ self.rotation_matrix_
